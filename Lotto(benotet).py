...
programwahl=str(input('Wählen sie das was ihr Programm machen soll.\n"Def" um die Lottozahlen und ihre Zahlen ziehen zu lassen.\n"Auto" um die Zahlen von selbst miteinadner vergleichen zu lassen und ihnen die Anzahl an richtig getippten auszugeben.\n"Fullauto" um das Programm von selbst laufen zu lassen und ihnen die Prozentuale gewinnchance mitzuteilen.\n Bitte Eingeben: '))
if programwahl=='Def':
...
#Programm Welches Automatisch lotto spielt und die chance einen 6er pasch berechnet
